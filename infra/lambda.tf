...
#
#   input = jsonencode({
#     IamRole                = aws_iam_role.extrato_lancamento_glue_msk_secleanup_role.arn
#     BucketName           =  aws_s3_bucket.extrato_lancamento_glueoutput_bucket.arn
#   })
#
# }
#
...
#
#   input = jsonencode({
#     IamRole                = aws_iam_role.extrato_lancamento_glue_msk_getbroker_role.arn
#     BucketName           =  aws_s3_bucket.extrato_lancamento_gluescript_bucket.arn
#   })
#
# }
#
